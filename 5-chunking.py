#grp of modifiers in the sentence mostly used nouns used to check the opinion delivered in the sentence
import nltk
...
# r'' here r is used to denote a regular expression sentence but it is not mandatory to put r 
# . is any character except for a newline
#  ? 0 or 1
#  RB.?  any form of adverb
